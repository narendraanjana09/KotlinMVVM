...
class FragmentD : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.buttonA).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.actionDtoA)
        }
        view.findViewById<Button>(R.id.buttonB).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.actionDtoB)
        }
        view.findViewById<Button>(R.id.buttonC).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.actionDtoC)
        }
